...
if (isset($_REQUEST['submit']) and $_REQUEST['submit'] != "") {
    ...
    if (($nombre == "") & ($categoria == "") & ($telefono == "") & ($email == "") & ($descripcion == "")) {
        ...
        header('location:/panel/nuevo/servicio');
        exit;
    } else if ($nombre == "") {
        ...
        if (!empty($_FILES['thumb']['tmp_name'])) {
            ...
            $ruta = '../../upload/servicios/' . $anor . '/' . $mesr . '';
        ...
        $casasCount    =    $db->getQueryCount('servicios', 'id');
        if ($casasCount[0]['total'] < 10000) {
            $data    =    array(
                ...
                'fPortada' => $codigo,
                'catSubServicio' => $categoria,
                'lugar' => $lugar,
                'usuario' => ($UserData['id']),
            );
            $insert    =    $db->insert('servicios', $data);
            ...
            if ($insert) {
                ...
                header('location:/panel/mis-servicios'); //exito
                exit;
            } else {

                setcookie("msg", "ups", time() + 2, "/");
                header('location:/panel/mis-servicios'); //sin cambios
                exit;
            }
        } else {

            setcookie("msg", "lim", time() + 2, "/");
            header('location:/panel/mis-servicios'); //limite
            exit;
        }
    }
}
                    ...
                    <div class="container">
                        ...
                        <div class="profile-edit-wrap">
                            <div class="profile-edit-page-header">
                                <h2><i class="fa fa-plus-circle"></i> Nuevo Servicio</h2>
                                <div class="breadcrumbs"><a href="/">Inicio</a><a href="/panel">Panel</a><span>Agregar nuevo servicio</span></div>
                            </div>
