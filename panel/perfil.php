                        ...
                        <div class="container">
                            ...
                            <div class="profile-edit-wrap">
                                <div class="profile-edit-page-header">
                                    <h2>Editar perfil</h2>
                                    <div class="breadcrumbs"><a href="/">Inicio</a><a href="/panel">Penl</a><span>Editar perfil</span></div>
                                </div>
                                <div class="row">
                                    <div class="col-md-3">
                                    ...
                                    <form method="post" enctype="multipart/form-data">
                                        <div class="col-md-7">
                                            ...
                                            <div class="profile-edit-container">
                                                ...
                                                <div class="custom-form">
                                                    <label>Tu nombre <i class="fa fa-user-o"></i></label>
                                                    <input type="text" name="nombre" value="<?php echo ($UserData['nombre']);?>">
                                                    
                                                    <label>Correo electrónico<i class="fa fa-envelope-o"></i>  </label>
                                        ...
                                        <div class="col-md-2">
                                            <div class="edit-profile-photo fl-wrap">
                                                <img style="width: 100%;" src="<?php echo ($fPerfil);?>" alt="">
                                        ...
                                        <div class="col-md-9">
                                            ...
                                            <div class="profile-edit-container">
                                                ...
                                                <div class="custom-form">
                                                    <button type="submit" name="submit" value="submit" class="btn  big-btn  color-bg flat-btn">Guardar<i class="fa fa-angle-right"></i></button>
                                                </div>
                                            </div>
