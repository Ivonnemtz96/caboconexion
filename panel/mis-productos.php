                        ...
                        <div class="container">
                            ...
                            <div class="profile-edit-wrap">
                                <div class="profile-edit-page-header">
                                    <h2><i class="fa fa-building"></i> Mis productos</h2>
                                    <div class="breadcrumbs"><a href="/">Inicio</a><a href="/panel">Panel</a><span>Mis productos</span></div>
                                </div>
                                <div class="row">
                                    <div class="col-md-3">
                                    ...
                                    <div class="col-md-9">
                                        <div class="dashboard-list-box fl-wrap">
                                            ...
                                            $prodCount	=	$db->getQueryCount('productos','*','AND usuario='.$UserData['id'].''[0]['total']);
                
                                            //VERIFICAMOS SI YA PRODUCTOS REGISTRADOS PARA LLAMAR A ESTE MODULO, SI NO, NO XD
                                            if (($prodCount)>0) { 
                                                require_once($_SERVER["DOCUMENT_ROOT"]."/modulos/userListaProductos.php");
                                            } else { echo '<div class="dashboard-header fl-wrap">
                                                <h3>Aún no haz registrado Productos.</h3>
                                            </div>'; }
                                            ?>
