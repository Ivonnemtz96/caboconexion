...
if (isset($_REQUEST['editId']) and $_REQUEST['editId']!=""){
	$categoria  =  $db->getAllRecords('catServicios','*',' AND id="'.$_REQUEST['editId'].'"','LIMIT 1');
...
if(isset($_REQUEST['submit']) and $_REQUEST['submit']!=""){
	...
	if($nombre==""){
        ...
        if(isset($_REQUEST['submit']) and $_REQUEST['submit']!=""){
	       ...
	       $update	=	$db->update('catServicios',$data,array('id'=>($_REQUEST['editId'])));
    
            if($update){
                setcookie("msg","catup",time() + 2, "/");
                header('location:/admin/nuevo/categoria-servicios'); //Exito en el cmabio
                exit;}
                else{
                    setcookie("msg","ups",time() + 2, "/");
...
<head>
  ...
  <title>CaboConexion - Editar - Servicio</title>
  <!-- General CSS Files -->
    ...
    <div class="main-wrapper main-wrapper-1">
      ...
      <div class="main-content">
        ...
        <ul class="breadcrumb breadcrumb-style ">
            ...
            <li class="breadcrumb-item active">Editar un categoría</li>
        </ul>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-12">
                                <a class="btn btn-primary" href="/admin/nuevo/categorias-servicios"><i class="fas fa-angle-double-left"></i> Volver</a>
