...
if (isset($_REQUEST['editId']) and $_REQUEST['editId']!=""){
	$categoria  =  $db->getAllRecords('catSubProd','*',' AND id="'.$_REQUEST['editId'].'"','LIMIT 1');
...
if(isset($_REQUEST['submit']) and $_REQUEST['submit']!=""){
	...
	if($nombre==""){
        ...
        if(isset($_REQUEST['submit']) and $_REQUEST['submit']!=""){
	       ...
	       $update	=	$db->update('catSubProd',$data,array('id'=>($_REQUEST['editId'])));
    
            if($update){
                setcookie("msg","catsubup",time() + 2, "/");
                header('location:/admin/nuevo/subcategoria-productos'); //Exito en el cmabio
                exit;}
                else{
                    setcookie("msg","ups",time() + 2, "/");
        ...
        $CategoriaPadre = $db->getAllRecords('catProducto','*', 'AND id="'.($categoria['categoria']).'"LIMIT 1 ');
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-12">
                                <a class="btn btn-primary" href="/admin/nuevo/subcategoria-productos"><i class="fas fa-angle-double-left"></i> Volver</a>
