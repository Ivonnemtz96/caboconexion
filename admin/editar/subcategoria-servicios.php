...
if (isset($_REQUEST['editId']) and $_REQUEST['editId']!=""){
	$categoria  =  $db->getAllRecords('catSubServicios','*',' AND id="'.$_REQUEST['editId'].'"','LIMIT 1');
...
if(isset($_REQUEST['submit']) and $_REQUEST['submit']!=""){
	...
	if($nombre==""){
        ...
        if(isset($_REQUEST['submit']) and $_REQUEST['submit']!=""){
	       ...
	       $update	=	$db->update('catSubServicios',$data,array('id'=>($_REQUEST['editId'])));
    
            if($update){
                setcookie("msg","catsubup",time() + 2, "/");
                header('location:/admin/nuevo/subcategoria-servicios'); //Exito en el cmabio
                exit;}
                else{
                    setcookie("msg","ups",time() + 2, "/");
        ...
        $CategoriaPadre = $db->getAllRecords('catServicios','*', 'AND id="'.($categoria['categoria']).'"LIMIT 1 ');
...
<head>
  ...
  <title>CaboConexion - Editar - Catgoría</title>
  <!-- General CSS Files -->
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <select name="categoria" class="form-control selectric" required>
                                        <option selected value="<?php echo $CategoriaPadre['id'];?>">Actual: <?php echo $CategoriaPadre['nombre'];?></option>
                                        <?php
                            ...
                            <div class="col-12">
                                <a class="btn btn-primary" href="/admin/nuevo/subcategoria-servicios"><i class="fas fa-angle-double-left"></i> Volver</a>
